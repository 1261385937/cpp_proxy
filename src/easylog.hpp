...
inline auto set_logger_module_level(
	const std::string& module_name, level::logger_level level) {
...
inline std::shared_ptr<logger_module_##module_name> \
g_logger_module_##module_name = std::make_shared<logger_module_##module_name>(); \
}\
}
